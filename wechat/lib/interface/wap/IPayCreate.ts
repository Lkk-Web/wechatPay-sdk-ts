...
import { IPayCreateReq, ISceneInfo } from "../common/IPayCreate";

// https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter3_3_1.shtml
export interface ISceneH5Info extends ISceneInfo {
    h5_info?: {
        type: string
        app_name?: string
        app_url?: string
...
export interface IPayCreateH5Req extends IPayCreateReq {
    scene_info: ISceneH5Info
}


export interface IPayCreateRes { h5_url: string }

export const PathPayCreate = 'pay/transactions/h5'